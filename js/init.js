...
function populateOwnerSelect(id){const el=document.getElementById(id);if(!el)return;el.innerHTML=`<option value="">Oasis Farm</option>`+owners.map(o=>`<option value="${o.id}">${o.first}${o.last?' '+o.last:''}</option>`).join('');}
